...
<NFe xmlns="http://www.portalfiscal.inf.br/nfe">
  <infNFe Id="NFe${chave}" versao="4.00">
    ...
    <infAdic><infCpl>DOCUMENTO GERADO EM AMBIENTE DE HOMOLOGACAO PELO SISTEMA SCIENTIA INDUSTRIAL - SEM VALOR FISCAL. Pedido ${esc(pedido.numero)}.</infCpl></infAdic>
  </infNFe>
</NFe>`;
}
